...
cat <<-EOF > control
	...
	Architecture: all
	Version: ${VERSION}-1
	Depends: php8.5-cli | php8.4-cli | php8.3-cli | php8.2-cli | php8.1-cli | php8.0-cli | php7.4-cli, libmono-corlib4.5-cil, libmono-system-core4.0-cil, libmono-system-runtime-serialization4.0-cil
	Provides: xp-runners
