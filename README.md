...
```sh
$ curl -sSL https://baltocdn.com/xp-framework/xp-runners/distribution/downloads/i/installer/setup-8.5.0.sh | sh
# ...
```
...
$ xp version
XP 10.9.1 { PHP/8.0.3 & Zend/4.0.3 } @ Windows NT SURFACE 10.0 build 19042 (Windows 10) AMD64
