...
```sh
$ curl -sSL https://bintray.com/artifact/download/xp-runners/generic/setup-7.7.0.sh | sh
# ...
```
...
$ xp version
XP 7.4.0 { PHP 7.0.9 & ZE 3.0.0 } @ Windows NT SLATE 10.0 build 10586 (Windows 10) i586
